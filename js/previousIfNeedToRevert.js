// Handlebars.registerHelper('last', function(todos) {
// 	//return new Handlebars.SafeString('should be here');
// 	for (var i = todos.length - 1; i >= 0; i--) {
// 		console.log(i);
// 		if (todos[i].nestedTodos.length > 0) {
// 			console.log(i);
// 			console.log(todos[i]);
// 			return Handlebars.helpers.last.call(todos[i].nestedTodos, todos[i].nestedTodos);
...
var App = {
	...
	[/*{id: "1", text: "one", completed: true, nestedTodos:[]},
			{id: "2", text: "two", completed: false, nestedTodos:[
				{id: "2a", text: "two-a", completed: false, nestedTodos:[
					{id: "2a-a", text: "twoA-a", completed: false, nestedTodos:[]},
					{id: "2a-b", text: "twoA-b", completed: false, nestedTodos:[
						{id: "2a-b-a", text: "twoA-b-a", completed: false, nestedTodos:[]}
				]}
			]}]},
	*/],
	init: function() {
	...
	// 	innerInput.classList.add('show');
	// 	lastListItem.appendChild(innerDiv);
	// 	lastListItem.appendChild(innerInput);
	// 	return lastListItem;
	// },
	createEventListeners: function() {
		...
		//todoList.addEventListener('focus', this.delegateEvents.bind(this));
	},
